...
<link rel="shortcut icon" href="/images/favicon.ico" type="image/x-icon" />
  ...
  <body>
      <div class="container">
	  <div class="header">
	      <div class="SmallHeader shLeft">Hostname: <?php echo exec('cat /etc/hostname'); ?></div><div class="SmallHeader shRight">Pi-Star: <?php echo $_SESSION['PiStarRelease']['Pi-Star']['Version'].'<br />';?> <?php echo $version; ?></div>
