...
<div class="divTable" id="hwInfoTable">
  <div class="divTableBody">
    ...
    <div class="divTableRow">
      <div class="divTableCell cell_content middle"><a class="tooltip" href="#" style="border-bottom:1px solid; color:<?php echo $textContent; ?>;"><?php echo $load; ?>%<span><strong>Platform:</strong> <?php echo $_SESSION['PiStarRelease']['Pi-Star']['Platform'];?><br /><strong><?php echo 'OS:</strong> ' . $system['os'] . ", release v" . $system['os_ver']; ?><br /><strong>Linux Kernel:</strong> <?php echo php_uname('r');?><br /><?php echo $os; ?><strong>Uptime:</strong> <?php  echo(str_replace("up", "", exec('uptime -p')));?></a></span></div>
